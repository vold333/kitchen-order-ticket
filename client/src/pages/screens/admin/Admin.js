...
import { FaUserPlus, FaClipboardList, FaChartLine, FaSignOutAlt, FaHistory, FaRegCalendarAlt, FaComment } from "react-icons/fa";
    ...
    <div className="flex h-screen bg-gray-200 flex-col font-sans">
      ...
      <header className="w-full bg-blue-50 py-2 sm:p-2 px-6 flex justify-between items-center">
        <div className="flex items-center space-x-4">
          ...
          <h1 className="text-2xl sm:text-2xl font-bold text-blue-950">KOT Admin</h1>
        </div>
        <div className="flex items-center space-x-4">
          <button
            onClick={logout}
          ...
          <nav className="flex-1 space-y-4 text-blue-950">
            <Link
              ...
              className={`flex items-center py-2 px-4 font-semibold rounded-full ${
                location.pathname === "/admin/dashboard" ? "bg-blue-200 text-secondary" : "hover:bg-blue-200"
              }`}
            ...
            <Link 
              ...
              className={`flex items-center py-2 px-4 font-semibold rounded-full ${
                location.pathname === "/admin/add-employee" ? "bg-blue-200 text-secondary" : "hover:bg-blue-200"
              }`}
              onClick={closeSidebar}
            >
            ...
            <Link
              to="/admin/add-table"
              className={`flex items-center py-2 px-4 font-semibold rounded-full ${
                location.pathname === "/admin/add-table" ? "bg-blue-200 text-secondary" : "hover:bg-blue-200"
              }`}
              onClick={closeSidebar}
            >
            ...
            <Link
              to="/admin/add-category-menu"
              className={`flex items-center py-2 px-4 font-semibold rounded-full ${
                location.pathname === "/admin/add-category-menu" ? "bg-blue-200 text-secondary" : "hover:bg-blue-200"
              }`}
              onClick={closeSidebar}
            >
            ...
            <Link
              to="/admin/cook-comments"
              className={`flex items-center py-2 px-4 font-semibold rounded-full ${
                location.pathname === "/admin/cook-comments" ? "bg-blue-200 text-secondary" : "hover:bg-blue-200"
              }`}
              onClick={closeSidebar}
            >
            ...
            <Link
              to="/admin/calendar"
              className={`flex items-center py-2 px-4 font-semibold rounded-full ${
                location.pathname === "/admin/calendar" ? "bg-blue-200 text-secondary" : "hover:bg-blue-200"
              }`}
              onClick={closeSidebar}
            >
            ...
            <Link
              to="/admin/history"
              className={`flex items-center py-2 px-4 font-semibold rounded-full ${
                location.pathname === "/admin/history" ? "bg-blue-200 text-secondary" : "hover:bg-blue-200"
              }`}
              onClick={closeSidebar}
            >
